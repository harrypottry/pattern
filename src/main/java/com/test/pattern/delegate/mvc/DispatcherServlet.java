package com.test.pattern.delegate.mvc;

import com.test.pattern.delegate.mvc.controllers.MemberController;
import com.test.pattern.delegate.mvc.controllers.OrderController;
import com.test.pattern.delegate.mvc.controllers.SystemController;
