package com.test.pattern.adapter.loginadapter.v2;

import com.test.pattern.adapter.loginadapter.ResultMsg;
import com.test.pattern.adapter.loginadapter.v1.service.SiginService;
import com.test.pattern.adapter.loginadapter.v2.adapters.*;
